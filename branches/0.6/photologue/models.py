...
FILTER_CHOICES = ["None"]
for n in dir(PIL.ImageFilter):
    klass = getattr(PIL.ImageFilter, n)
    if type(klass) == 'classobj' and \
       issubclass(klass, ImageFilter.BuiltinFilter):
        FILTER_CHOICES.append(klass.name)
